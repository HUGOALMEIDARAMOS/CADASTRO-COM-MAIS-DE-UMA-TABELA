...
<div id="main" class="container">
    ...
    <form action="cadastrar_form.php" class="borda_form" id="form" name="form" method="post">
        ...
        <div class="row">
            ...
            <div class="form-group col-md-5">
                ...
                <input type="text" class="form-control" id="ultimo_nome" name="ultimo_nome" placeholder="Segundo Nome">
            </div>

            <div class="form-group col-md-2">
                <label for="telefone">Telefone</label>
                <input type="text" class="form-control" id="telefone" name="telefone" placeholder="(xx)xxxxx-xxxx" maxlength="11"
        ...
        <div class="row">
            ...
            <div class="form-group col-md-2">
                ...
                <input type="text" class="form-control" id="cep" name="cep" placeholder="xxxxx-xxx" maxlength="8"
                       onkeypress='return SomenteNumero(event);'>
            </div>
        </div>
